...
#[test]
fn sfb_len_laguna_dims() {
    // Laguna-S-2.1: H=3072, I=1024, top_k=10.
    // w13: n=2I=2048, k=H=3072 -> 384 KiB/expert.
    assert_eq!(sfb_len(2048, 3072), 393216);
    // w2: n=H=3072, k=I=1024 -> 192 KiB/expert.
    assert_eq!(sfb_len(3072, 1024), 196608);
}
